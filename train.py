...
dataset = SkalpDataset(r"/content/DepthEstimation/training_data/bag_1/_start_saki4", r"/content/DepthEstimation/training_data/bag_1/_start_saki4/selected_indexes", transforms)
